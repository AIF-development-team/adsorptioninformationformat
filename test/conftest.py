...
bel_data = [('unknown', 'Ar_test/1.DAT'), ('Sample_E', 'bel/Sample_E.DAT'),
            ...
            ('DUT-67', 'DUT-67/DUT-67_H2O_298K.DAT'), ('DUT-67', 'DUT-67/DUT-67-N2_77K.DAT'),
...
qnt_data = [
    ...
    ('DUT-23', r'DUT-23/NK_CU(BIPY)(BTB)_10-11_DMF-ETOH_CO2_84PKT_N2_N2 (Raw Analysis Data).txt'),
...
BELcsv_JIS_data = [('DMOF', 'DMOF/ASch082C_Zntmbdcdabco_C2H6_Exp190819a.csv'),
                   ('DMOF', r'DMOF/ASch082B_Zndmbdcdabco_C2H4_Exp191004a_weight correction.csv'),
