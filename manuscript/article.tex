...
For example produced AIF files can also be read using existing CIF methods, such as the \texttt{gemmi} python library that is considered the the fastest open-source CIF parser.\cite{gemmi}
