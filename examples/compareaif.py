...
digit_ads_press = np.genfromtxt('example/Default Dataset.csv',
                                delimiter=',')[:, 0]
digit_ads_amount = np.genfromtxt('example/Default Dataset.csv',
                                 delimiter=',')[:, 1]

digit_des_press = np.genfromtxt('example/Default Dataset2.csv',
                                delimiter=',')[:, 0]
digit_des_amount = np.genfromtxt('example/Default Dataset2.csv',
                                 delimiter=',')[:, 1]
